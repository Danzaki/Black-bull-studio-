  ...
  return (
    <AuthLayout title="Sign in to your account">
      <AuthCard
        ...
        aside={<p className="text-sm text-slate-300">Secure email sign in with password and verification support.</p>}
      >
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="/auth/forgot-password" className="text-sm text-slate-300 transition hover:text-white">
              Forgot password?
            </a>
          </div>
